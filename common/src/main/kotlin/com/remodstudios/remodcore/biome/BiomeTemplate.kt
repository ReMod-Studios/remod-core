...
class BiomeTemplate internal constructor() {
    ...
    var temperatureModifier = Biome.TemperatureModifier.NONE
    ...
    class SpecialEffects internal constructor() {
        ...
        var grassColorModifier = BiomeEffects.GrassColorModifier.NONE
    ...
    class GenerationSettings internal constructor() {
        ...
        inner class VanillaGeneration internal constructor() {
            ...
            fun overworldDefaults() {
                // equivalent to what old BiomeRegistryHelper adds with addDefaults = true
                defaultUndergroundStructures()
                landCarvers()
                defaultLakes()
                dungeons()
                mineables()
